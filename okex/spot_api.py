...
class SpotAPI(Client):
    ...
    # take order
    def take_order(self, otype, side, instrument_id, size, notional, margin_trading=1, client_oid='', price='', funds='', order_type=0):
        params = {'type': otype, 'side': side, 'instrument_id': instrument_id, 'size': size, 'notional': notional, 'client_oid': client_oid,
